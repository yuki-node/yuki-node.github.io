...
你会注意到，上面『Good』例子有一个特点：它帮助开发者理解你提出建议的原因。虽然不需要在每个审查评论中都写这样的解释，但适时说明你的意图、遵循的最佳实践或者建议如何提升代码健康度，往往能取得更好效果。
...
### 让开发者沮丧 {#upsetting_developers}

### 稍后清理 {#clean_up_later}

### 解决冲突 {#resolve_conflicts}
...
翻译这篇：https://google.github.io/eng-practices/review/emergencies.html
